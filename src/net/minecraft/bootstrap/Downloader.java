    ...
    while (true) {
      ...
      try {
        ...
        if (code == 2)
        {
            ...
            try {
                URL hashurl = new URL("https://dl.dropboxusercontent.com/u/69130671/Minecraft/BML/launcher.pack.lzma.hash");
                Scanner s = new Scanner(hashurl.openStream());
                // read from your scanner            
                eTag = s.nextLine();
                s.close();
             }
             catch(Exception e) {
                throw new FatalBootstrapError(new StringBuilder().append("Unable to get MD5: ").append(e).toString());
             }
 ...
 * Qualified Name:     net.minecraft.bootstrap.Downloader
